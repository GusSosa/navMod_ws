...
(cl:defmethod cl:initialize-instance :after ((m <ImageSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_work-srv:<ImageSrv-request> is deprecated: use opencv_work-srv:ImageSrv-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ImageSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_work-srv:<ImageSrv-response> is deprecated: use opencv_work-srv:ImageSrv-response instead.")))

(cl:ensure-generic-function 'image_data-val :lambda-list '(m))
(cl:defmethod image_data-val ((m <ImageSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opencv_work-srv:image_data-val is deprecated.  Use opencv_work-srv:image_data instead.")
  (image_data m))
